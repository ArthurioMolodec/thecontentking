...
<head>
    ...
    <title>TheContentKing Rewriter</title>
...
<body>
    ...
    <section class="section">
        ...
        <h1 class="mb-5 mt-2">TheContentKing Rewriter</h1>
        ...
        <div class="columns">
            ...
            <div class="column">
                ...
                <div class="field">
                    <label class="label">Copied Article | Break the article in small para for better results</label>
                    <div class="control">
                ...
                <div class="field is-grouped">
                    <div class="control mt-3">
                        <button id="rewriteBtn" class="button is-primary">Rewrite</button>
                    </div>
                </div>
            ...
            <div class="column">
                ...
                <div class="field">
                    <label class="label">Rewritten by AI</label>
                    <div class="control">
...
<script>
    ...
    const init = () => {
        ...
        let dataFromStorage = localStorage.getItem("rewritecontent");
        ...
        setInterval(() => {
            ...
            localStorage.setItem("rewritecontent", JSON.stringify(objToSave));
    ...
    const callAPI = async (para) => {
        ...
        try {
            ...
            const api = await axios.post("rewriterapi", {
                para: para,
            });
    ...
    rewriteBtn.addEventListener("click", async () => {
        ...
        if (copiedArticle.value !== "" && rewriteBtn.innerText !== "Rewriting...") {
